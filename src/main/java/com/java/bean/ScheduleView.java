...
import com.java.controller.CallendarControler;
import com.java.view.BindingInterfaceWeb;
...
public class ScheduleView implements Serializable {
    ...
    public void onEventResize(ScheduleEntryResizeEvent event) {
        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Evento redimencionado", "Day delta:" + event.getDayDelta() + ", Minute delta:" + event.getMinuteDelta());
